...
def main() -> int:
    ...
    print()
    print("Integration:")
    print("  For Python-based coding agents, prefer the vendored adapter generated by Mnemix Context:")
    print("  .ai/mnemix/adapters/coding_agent_adapter.py")
    print("  See also: .ai/mnemix/MEMORY_POLICY.md")
    return 0
